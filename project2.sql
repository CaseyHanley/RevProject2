...
create table Delivery_Driver(tabledfdfd varchar2(55));
select * from menu_items;
select * from users;
delete users where firstname = 'rome';
...
Alter Table orders DROP CONSTRAINT uid2_key FOREIGN KEY (u_id) REFERENCES users(u_id) ON DELETE CASCADE;

Alter Table delivery_Address DROP CONSTRAINT uid_key FOREIGN KEY (u_id) REFERENCES users(u_id) ON DELETE CASCADE;
